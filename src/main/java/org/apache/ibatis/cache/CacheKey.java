...
public class CacheKey implements Cloneable, Serializable {
  ...
  private int hashcode; //CacheKey的hash值，由update方法实时算出
  ...
  public void update(Object object) {
    ...
    //更新count，checksum和hashcode
    count++;
    checksum += baseHashCode;
    baseHashCode *= count;

    hashcode = multiplier * hashcode + baseHashCode; //通过这个算法保证hashcode唯一
    //将对象添加到updateList
  ...
  public boolean equals(Object object) {
    ...
    //上面都相同的话，再逐一比较两个updateList中的元素是否相同
